...
- quality-contract: 신규 130줄 (_core/quality-contracts/QUALITY_CONTRACT.md)
...
- _core/에서 수정 → sync-tools.cmd → 전 프로젝트 반영
...
- _core/REGISTRY.md — 전체 리소스 카탈로그
- _core/manifesto.md — 비즈니스 매니페스토 (예정)
